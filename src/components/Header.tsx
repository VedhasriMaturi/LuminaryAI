    ...
    <header className="glass-panel border-b border-slate-205/50 dark:border-slate-805/50 px-6 py-4 flex items-center justify-between sticky top-0 z-20">
      ...
      <div className="flex items-center gap-3 md:gap-4">
        ...
        <button 
          ...
          className="flex items-center gap-2 px-3 py-2 text-xs font-bold rounded-xl bg-slate-100 hover:bg-slate-200 dark:bg-slate-850 dark:hover:bg-slate-800 border border-slate-200/50 dark:border-slate-700/50 text-slate-700 dark:text-slate-200 transition-all cursor-pointer"
        >
          <Upload size={14} />
        ...
        <div className="relative">
          <button 
            ...
            className="p-2.5 rounded-xl bg-slate-100 dark:bg-slate-850 hover:bg-slate-250 dark:hover:bg-slate-800 border border-slate-200/50 dark:border-slate-700/50 text-slate-600 dark:text-slate-300 relative transition-all active:scale-95 cursor-pointer"
          >
            <Bell size={16} />
        ...
        <div className="relative">
          <select 
            ...
            className="bg-slate-100 dark:bg-slate-850 hover:bg-slate-200 dark:hover:bg-slate-800 text-xs font-bold rounded-xl px-3 py-2 border border-slate-200/50 dark:border-slate-700/50 outline-none text-slate-700 dark:text-slate-205 cursor-pointer transition-colors"
          >
        ...
        <button 
          ...
          className="p-2.5 rounded-xl bg-slate-100 dark:bg-slate-850 hover:bg-slate-200 dark:hover:bg-slate-800 border border-slate-200/50 dark:border-slate-700/50 text-slate-600 dark:text-slate-350 transition-all active:scale-95 cursor-pointer"
        >
